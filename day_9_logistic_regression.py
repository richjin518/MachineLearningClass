...
def cancer_tumor_demo():
    ...
    joblib.dump(estimator, 'D:\DL_data\lr.pkl')
    ...
    # 5) estimator 2
    estimator2 = joblib.load('D:\DL_data\lr.pkl')

    # 6) model evaluation 2
    print("weights: ", estimator2.coef_)
    print("b: ", estimator2.intercept_)
    ...
    # precision, recall, F-1 score 2
    report2 = classification_report(y_test, y_predict, labels=[2,4], target_names=["good", "bad"])
    print(report2)
...
def load_pkl_demo():
    ...
    # 5) estimator
    estimator = joblib.load('D:\DL_data\lr.pkl')
